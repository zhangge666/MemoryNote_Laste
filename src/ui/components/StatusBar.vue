<template>
  <div class="h-7 border-t border-slate-200 dark:border-slate-700 text-xs flex items-center justify-between px-4 bg-white/95 dark:bg-slate-800/95 backdrop-blur-sm">
    <div class="flex items-center space-x-4">
      <div class="flex items-center space-x-2">
        <div class="w-2 h-2 bg-green-500 rounded-full"></div>
        <span class="text-slate-600 dark:text-slate-400">{{ statusText }}</span>
      </div>
    ...
    <div class="flex items-center space-x-4">
      <div v-if="active" class="flex items-center space-x-3">
        ...
        <div class="flex items-center space-x-2">
          ...
          <span class="text-slate-600 dark:text-slate-400">{{ cursorText }}</span>
        </div>
        ...
        <div class="flex items-center space-x-2">
          ...
          <span class="text-slate-600 dark:text-slate-400">{{ wordsText }}</span>
        </div>
      </div>
